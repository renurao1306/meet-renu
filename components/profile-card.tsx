...
export default function ProfileCard() {
  return (
    <Card className="w-full mb-20 overflow-hidden">
      <CardContent className="flex items-center space-x-10 p-6">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-muted-foreground text-sm mb-6">Student at NMIMS Mukesh Patel School of Technology Management & Engineering</p>
