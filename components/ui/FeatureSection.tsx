...
export const FeatureButton = ({
  ...
  return (
    <button className="mt-10 relative inline-flex h-16 w-100 overflow-hidden rounded-md p-[1px] focus:outline-none focus:ring-1 focus:ring-slate-200" onClick={onClick}>
